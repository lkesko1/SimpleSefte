I  - Šta je uraðeno?
1. Uraðena je validacija sljedeæih formi:
...
3. Korišten je Ajax kako se stranice ne bi osvježavale prilikom klika na linkove iz menija. To je isto uraðeno za button na poèetnoj stranici, koji vodi na Meni. U index.html izdvojeni su header i footer, a mijenja se samo sadržaj za div 'glavni' uèitavanjem odgovarajuæih stranica.
...
Folder Spirala 2: 
	...
	1. Folder Javascript - Folder u kojem se nalaze skripte. Napravljene su 4 skripte kako bi ih razvrstala:
		a) Validacija.js - sadrži tri funkcije za 3 forme;
		b) PrikaziMeni.js - sadrži funkciju za prikaz dropdown menija;
		c) OtvoriSliku.js - sadrži funkciju za otvaranje slike;
		d) UcitavanjeStranice.js - sadrži 2 funkcije: za otvaranje stranica putem indexa i za otvaranje odgovarajuæe stranice putem buttona Meni;
	2. Folder HTML - Folder sa svim html podstranicama: 
